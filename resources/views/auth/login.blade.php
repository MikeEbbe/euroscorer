        ...
        <div
            ...
            <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                ...
                <form class="space-y-4 md:space-y-6" method="post" action="{{ route('login.perform') }}">
                    ...
                    <button type="submit"
                        class="w-full text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-semibold rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Inloggen</button>
                    <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                        Geen account? <a href="/register"
                            class="font-semibold text-primary-600 hover:underline dark:text-primary-500">Registreer
                            je</a>
                    </p>
                </form>
            </div>
