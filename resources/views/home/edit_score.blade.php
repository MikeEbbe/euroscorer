...
<div class="grid grid-cols-3 items-center justify-center md:justify-between px-4 my-6 md:my-12">
    <a href="{{ $redirect_url }}"
        class="text-sm font-medium text-center w-8/12 md:w-3/12 px-4 py-2 bg-gray-300 dark:bg-gray-700 text-gray-900 dark:text-white rounded-md mr-4">
        Terug
    </a>
    ...
    <div class="grid grid-cols-10">
        <div class="px-4 col-span-10 md:col-start-4 md:col-span-4">
            ...
            <div class="text-center">
                <button type="submit"
                    class="w-6/12 md:w-4/12 text-white bg-primary-600 hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-base md:text-sm px-5 py-3 md:py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Bijwerken</button>
            </div>
        </div>
    </div>
</form>
