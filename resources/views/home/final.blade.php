    ...
    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
        ...
        <tbody>
            ...
            <tr class="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                <td
                    class="px-1 py-3 md:w-4 md:px-5 md:py-3 border-l-[12px] @if($loop->iteration === 1) border-green-700 @elseif($loop->iteration <= 5) border-green-500 @else border-red-500 @endif">
                    <img class="max-h-[22px] md:max-h-[26px] w-auto border border-gray-300" src="{{ $score->participant->country->flag }}"
